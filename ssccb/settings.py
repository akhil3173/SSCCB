"""
Django settings for ssccb project.
...
SECRET_KEY = '=-j84(*ua(2bnswcue-@*)s%gdo^vf_n+jn+4_n$jgdya9^63r'
...
WSGI_APPLICATION = 'ssccb.wsgi.application'
